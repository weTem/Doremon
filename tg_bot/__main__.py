...
PM_START_TEXT = """
**ʜᴇʟʟᴏ {}, ᴍʏ ɴᴀᴍᴇ ɪs *{}*!\n 
ɪ ᴀᴍ ʜᴇʀᴇ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ **ʙᴇᴀᴜᴛɪғᴜʟ** ɢʀᴏᴜᴘ!*.\nɪ ᴀᴍ ᴠᴇʀʏ ꜰᴀꜱᴛ ᴀɴᴅ  ᴍᴏʀᴇ ᴇꜰꜰɪᴄɪᴇɴᴛ ᴛᴇʟᴇɢʀᴀᴍ ʙᴏᴛ.  ɪ ᴘʀᴏᴠɪᴅᴇ ᴀᴡᴇꜱᴏᴍᴇ  ꜰᴇᴀᴛᴜʀᴇꜱ ᴡʜɪᴄʜ ᴀ ᴏᴡɴᴇʀ ʟᴏᴏᴋs ꜰᴏʀ...sᴜᴄʜ ᴀs : ꜰɪʟᴛᴇʀ ,ᴡᴀʀɴ ꜱʏꜱᴛᴇᴍ,ꜱᴀᴠᴇ ɴᴏᴛᴇꜱ, ꜰʟᴏᴏᴅ, ʙᴀɴ ᴀɴᴅ ᴍᴏʀᴇ!\n
**ᴅᴇᴠ :** [ʜɪᴍᴀɴsʜᴜ 🇮🇳](t.me/cloneXcopy).
 
ʏᴏᴜ ᴄᴀɴ ғɪɴᴅ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs ʙʏ ᴄᴏᴍᴍᴜɴɪᴄᴀᴛɪɴɢ ᴍᴇ ᴠɪᴀ ʙᴜᴛᴛᴏɴs!
"""
...
def alain(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("📬*ʀᴇᴘᴏ ғᴏʀ ʙᴀʙʏɢɪʀʟ ʙᴏᴛ ɪs* :- [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/telegram)", parse_mode=ParseMode.MARKDOWN)
    update.effective_message.reply_text("📬*ʀᴇᴘᴏ ғᴏʀ ʙᴀʙʏɢɪʀʟ ʙᴏᴛ ɪs* :- [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/telegram)_", parse_mode=ParseMode.MARKDOWN)
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                   [[
                        InlineKeyboardButton(
                            text="ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🌩️",url="t.me/{}?startgroup=true".format(bot.username))
                    ],
                      [
                         InlineKeyboardButton(
                             text=" ʜᴇʟᴘ🌩️",
    ...
    try:
        if mod_match:
            ...
            query.message.reply_text(HELP_STRINGS,
                                     parse_mode=ParseMode.MARKDOWN,
                                     reply_markup=InlineKeyboardMarkup(
                                         paginate_modules(curr_page - 1, HELPABLE, "ʜᴇʟᴘ")))
            ...
            query.message.reply_text(HELP_STRINGS,
                                     parse_mode=ParseMode.MARKDOWN,
                                     reply_markup=InlineKeyboardMarkup(
                                         paginate_modules(next_page + 1, HELPABLE, "ʜᴇʟᴘ")))
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("ʜᴇʏᴀ, ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴛʜᴇ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="💠 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 💠",url="@spamwarriors")]]))
